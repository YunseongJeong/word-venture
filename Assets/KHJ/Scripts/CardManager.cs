...
namespace Deck_Manage {
    public class CardManager : MonoBehaviour
    {
        ...
        void WordOS_state()
        {
            ...
            {
                case 0:
                    wordSO.words[0].percent = 10; // shoot
                    wordSO.words[1].percent = 0; // summon
                    wordSO.words[2].percent = 0; // drop
                    wordSO.words[3].percent = 10; // fire
                    wordSO.words[4].percent = 0; // rock
                    wordSO.words[5].percent = 0; // ice
                    wordSO.words[6].percent = 0; // lightning
                    wordSO.words[7].percent = 0; // holy
                    break;
                case 1: // summon, drop 얻음
                    wordSO.words[0].percent = 10;
                    wordSO.words[1].percent = 5;
                    wordSO.words[2].percent = 5;
                    wordSO.words[3].percent = 10;
